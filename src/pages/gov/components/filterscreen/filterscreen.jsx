  ...
  return (
    <div className="filterPanel">
      ...
      <Productinfo
        ...
        onAllCurrencyChecked={props.onAllCurrencyChecked}
        onSelectCurrencyCheckbox={props.onSelectCurrencyCheckbox}
        onSelectIssueTypeCheckbox={props.onSelectIssueTypeCheckbox}
        onAllIssueTypeChecked={props.onAllIssueTypeChecked}
        setFromMaturityDate={props.setFromMaturityDate}
        setToMaturityDate={props.setToMaturityDate}
      ></Productinfo>
      <Flagsstatus
        data={props.data}

    ...
    this.state = {
      ...
      gridScreenData: {
        ...
        colDefs: [
          ...
          { headerName: "Exchange", field: "exchange", width: "auto" },
          {
          ...
          {
            headerName: "Last Price Updated Stamp",
            field: "lastPriceUpdatedStamp",
            width: "auto",
          },
          {
            headerName: "Last Price Alert Stamp",
            field: "lastPriceAlertStamp",
            width: "auto",
          },
        ],
        defaultColDef: {
...
export default ThresholdAlertProvider;
